...
describe('candidate module', () => {
    ...
    it(' create a candidate', async (done) => {
        ...
        axios.post('http://206.189.235.9:5000/api/candidate/add', candidate, {
    ...
    it(' return all candidates', (done) => {
        axios.get('http://206.189.235.9:5000/api/candidate/', {
            headers: { 'x-auth': token }
        }).then(res => {
    ...
    it(' add review detail to candidate', (done) => {
        ...
        axios.post('http://206.189.235.9:5000/api/candidate/update/5cebb82167b1e84892db9e63', review, {
            headers: { 'x-auth': token }
        }).then(res => {
