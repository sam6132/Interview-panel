...
class TeamMember extends React.Component {
	...
	createTeamMembers = () => {
		...
		axios
			.post(`http://localhost:5000/api/team/addTeamMembers/${team_id}`, this.state.teamMembers, {
			...
			<div>
				...
				<div className="container mt-sm">
					<div className="card bg-secondary shadow border-0">
						...
						<form className="form" role="form" onSubmit={this.handleSubmit} onChange={this.handleChange}>
